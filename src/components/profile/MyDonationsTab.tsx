      ...
      {(!donations || donations.length === 0) ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {donations.map((donation) => (
            <div key={donation.id} className="bg-surface-container-lowest rounded-3xl p-6 hover:translate-y-[-4px] hover:shadow-[0_40px_40px_rgba(47,46,46,0.06)] transition-all relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-lg font-bold font-headline text-on-surface leading-tight mb-1 group-hover:text-primary transition-colors">{donation.project_name}</h4>
